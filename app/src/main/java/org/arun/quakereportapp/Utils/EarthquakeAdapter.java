package org.arun.quakereportapp.Utils;
...
import org.arun.quakereportapp.R;
...
public class EarthquakeAdapter extends ArrayAdapter<Earthquake> {
	...
	public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
		...
		if(view == null) {
			view = LayoutInflater.from(getContext()).inflate(R.layout.list_item_earthquake, parent, false);
		}


		TextView tvMag =view.findViewById(R.id.mag_text_view);
		...
		TextView tvPlace =view.findViewById(R.id.place_text_view);
		tvPlace.setText(fullLocation[1]);

		//TextView tvOffset =view.findViewById(R.id.offset_text_view);


		Date date = new Date(current.getTimeInMilliSeconds());

		TextView tvDate =view.findViewById(R.id.date_text_view);
		tvDate.setText(formatDate(date));

		TextView tvTime =view.findViewById(R.id.time_text_view);
